  ...
  dashboard: {
    ...
    content: (
      <div className="space-y-6">
        <h1 className="text-3xl font-bold">歡迎來到儀表板</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="p-6">
            <h3 className="text-lg font-semibold mb-2">用戶統計</h3>
...
export default function DemoPage() {
  ...
  // 將頁面導覽函數暴露到 window 對象，供 AI 助手工具調用
  React.useEffect(() => {
        ...
        <AssistantSidebar>
          <div className="flex h-full">
            ...
            <div className="w-64 bg-muted/50 border-r p-4">
              <h2 className="text-lg font-semibold mb-4">應用導覽</h2>
              ...
              <div className="mt-8 p-4 bg-background rounded-lg border">
                <h3 className="text-sm font-medium mb-2">AI 助手提示</h3>
                <p className="text-xs text-muted-foreground">
                  您可以透過右側的 AI 助手來導覽頁面，例如說：
                  "帶我到設定頁面" 或 "顯示儀表板"
                </p>
              </div>
            </div>
